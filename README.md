...
Java 17+, Spring Boot, Git, CI/CD, JPA, Hibernate, PostgreSQL, Liquibase, Unit, Mockito, Kafka, RabbitMQ, Docker, Kubernetes.

 -демонстрация принципов микросервисной архитектуры;
 
 -реализация взаимодействия между сервисами через REST API или асинхронные сообщения;
